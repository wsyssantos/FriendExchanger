...
import com.list.contact.example.contactlist.user.UserFragment;
...
public class ContactListActivity extends BaseActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        ButterKnife.bind(ContactListActivity.this);
    ...
    private void configureToolbar() {
        ...
        ab.setTitle(R.string.title_contact);
        ab.setDisplayHomeAsUpEnabled(true);
    }

    private void configureFragment() {
        ContactListFragment userFragment = (ContactListFragment) getSupportFragmentManager().findFragmentById(R.id.contentFrame);
        if (userFragment == null) {
            userFragment = new ContactListFragment();
